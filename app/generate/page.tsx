...
export default function GeneratePage() {
  return (
    <main className="container mx-auto px-4 py-10">
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-white mb-2">Web Palette Generator</h1>
        <p className="text-slate-400 max-w-2xl">
          Pick a primary color and instantly get a full palette (primary, secondary, accent,
          neutral) with shades from 50 to 950. Export as CSS variables, Tailwind v3/v4, SCSS or
          Figma Tokens.
        </p>
      </div>
